            ...
            <div key={sectionName} className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-4">
                {people.map((person, index) => (
                  <div
                    key={index}
                    className="flex flex-col items-center p-3 bg-gray-800/50 rounded-xl backdrop-blur-sm 
                             hover:bg-gray-700/50 transition-all duration-300 transform hover:-translate-y-1"
                  >
                    <img
                      src={person.image}
                      alt={person.name}
                      className="w-12 h-12 rounded-full ring-2 ring-purple-500 p-0.5"
                    />
    ...
    return (
      <div className="grid grid-cols-3 gap-4 animate-fadeIn">
        {category.items?.map((item, index) => (
          <div
            key={index}
            className="group relative p-6 bg-gray-800/50 rounded-xl backdrop-blur-sm 
                     hover:bg-gray-700/50 transition-all duration-300 transform hover:-translate-y-1"
          >
            <div
            ...
            />
            <span className="relative text-sm font-medium text-gray-200">
              {item.name}
            </span>
          </div>
        ))}
  ...
  return (
    <div className="w-full max-w-2xl mx-auto mt-16 space-y-8">
      {eventData.map((event, index) => (
        <div key={index} className="rounded-[30px] overflow-hidden shadow-2xl">
          {/* Event Header */}
          <div
            className="relative h-[312px] bg-cover bg-center p-6 cursor-pointer transform transition-transform duration-300 hover:scale-[1.02]"
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-6">
                <img
                  ...
                  className="w-12 h-12 rounded-full ring-2 ring-white/50 p-0.5"
                />
                <div>
              ...
              <h1 className="text-3xl text-white mt-16 font-bold  mb-7 tracking-tight">
                {event.title}
              </h1>
              <div className="flex items-center gap-6 text-white mt-6">
                <p className="text-white/90 font-semibold leading-relaxed max-w-xs">
              ...
              <div className="absolute top-6 right-6 px-4 py-2 bg-black/30 rounded-full backdrop-blur-sm">
          ...
          {isMenuOpen && selectedEventIndex === index && (
            <div className="p-6 bg-[#272222] transition-all duration-500 ease-in-out">
              ...
              <div className="mt-8 pt-6 border-t border-gray-800">
                {/* Request Button */}
                <button
                  className="w-full mb-4 bg-gradient-to-r from-blue-600 to-blue-400 text-white py-3 rounded-lg font-medium hover:from-blue-700 hover:to-blue-500 transform hover:scale-[1.02] transition-all duration-300 focus:ring-2 focus:ring-blue-400"
                >
                  Request Invite
                </button>
