...
const PersonalProfileEdit = ({ onClose, initialData }) => {
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-2 bg-gray-700 text-white rounded-lg border border-gray-600 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent resize-none h-28"
              placeholder="Tell us a bit about yourself (max 250 characters)"
              maxLength={250}
            />
            <div className="text-right text-xs text-gray-400 mt-1">
              {subtext.length}/250 characters
            </div>
          </div>
