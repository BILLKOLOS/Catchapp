  ...
  return (
    <div className="min-h-screen bg-gray-50 font-jost mb-6">
      <div className="max-w-4xl mx-auto p-4 pt-16 pb-12 space-y-8">
        {/* Back Button */}
        <button onClick={handleBack} className="mb-4 flex items-center gap-1 text-[#272222] font-medium mt-10">
          <ArrowLeft size={18} />
          <span>Back</span>
        </button>
        ...
        <div className="flex justify-center mb-10">
          <button className="w-full max-w-md py-3 bg-gradient-to-r from-[#272222] to-[#3a3535] text-white font-bold rounded-xl shadow-lg hover:scale-105 transform transition-transform duration-200" onClick={() => setIsModalOpen(true)}>
            Request Invite
          </button>
        </div>
      </div>
